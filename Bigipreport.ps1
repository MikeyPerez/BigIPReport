...
#		3.4			2015-07-26		Add search highlighting														Patrik Jonsson	-
#									Add more entries per page
...
#		4.2.3		2016-08-29		Adding data group list parsing to json files								Patrik Jonsson	-
...
#		4.3.0		2016-01-10		Fixing support for partitions single configuration objects					Patrik Jonsson	-
...
#		4.6.8		2017-09-15		Adding support for version check											Patrik Jonsson	Yes
#
